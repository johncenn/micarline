...
class Menu
{
	...
	public static $menu = array(
	   ...
	   '订单'=>array(
        	'订单管理'=>array(
                '/order/order_list' => '实物订单列表',
        	    '/order/vr_order_list' => '到店服务订单列表',
        	    '/order/vr_order_exchange_show' => '服务码兑换',
		...
		'统计'=>array(
			...
			'商户数据统计'=>array(
			    ...
			    '/market/seller_details' => '商家结算明细',
			    '/market/user_details' => '用户提成结结算明细',
			)
		),
        ...
        '系统'=>array(
            ...
            '板块信息'=>array(
                '/system/bankuai_list' => '添加板块',
                '/system/plate_apply'  => '板块申请'
