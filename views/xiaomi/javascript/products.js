 ...
 */
function productClass(goods_id,user_id,promo,active_id,isjifen)
{
	_self         = this;
	...
	this.buyNow = function()
	{
		...
		var type    = 'goods';
		var xiaoshou_type = parseInt($.trim($('#xiaoshou_type').val()));
		...
		//普通购买
		var url = "/simple/cart2/id/"+id+"/num/"+buyNums+"/type/"+type+"/xiaoShouType/"+xiaoshou_type+"/seller_name/"+seller_name;
		//有促销活动（团购，抢购）
